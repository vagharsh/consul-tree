...
function getValue(path, obj, userRights) {
    var consulUrl = localStorage['consulUrl'],
        backendPath = localStorage['backendPath'];
...
function ccPaste(cas) {
    var parentId = localStorage['ccpObjParent'],
        ...
        path = localStorage['ccpSourcePaths'],
...
function sendToConsul(path, value, reload, updateBtn, userRights) {
    var consulUrl = localStorage['consulUrl'],
        backendPath = localStorage['backendPath'];
...
function exportConsul(data, consulTitle) {
    var consulUrl = localStorage['consulUrl'],
        backendPath = localStorage['backendPath'],
...
function customMenu(userRights) {
    var consulUrl = localStorage['consulUrl'],
        backendPath = localStorage['backendPath'],
