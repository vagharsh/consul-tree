...
`docker run --name consul-tree -d -v /opt/consul-tree/config.php:/var/www/html/config.php -p 8123:80 --restart always vagharsh/consul-tree:4.0`

**Current working version corresponds to the Image on Docker hub vagharsh/consul-tree:4.0**
